...
/**
 * <p>Clase Java para GeometryOneAxisInclinedNS complex type.
 * 
 ...
 *       &lt;attribute name="axisTilt" type="{http://geomodel.eu/schema/common/geo}inclination" default="30" /&gt;
...
@XmlType(name = "GeometryOneAxisInclinedNS")
public class GeometryOneAxisInclinedNS
    extends GeometryTracker
{

    @XmlAttribute(name = "axisTilt")
    ...
    /**
     * Obtiene el valor de la propiedad axisTilt.
     * 
     * @return
     *     possible object is
     *     {@link Double }
    ...
    /**
     * Define el valor de la propiedad axisTilt.
     * 
     * @param value
     *     allowed object is
     *     {@link Double }
     *     
     */
    public void setAxisTilt(Double value) {
        this.axisTilt = value;
    }
